...
// NOVO: Recebemos searchTerm e setSearchTerm
    ...
    <header className="bg-gradient-to-r from-[#0A3F74] to-[#080038] border-b border-[#1a2b44] py-4 px-6 flex items-center justify-between sticky top-0 z-50 shadow-xl">
      ...
      <div className="flex items-center space-x-5">
        <div className="relative hidden lg:block">
          ...
          {/* NOVO: Input agora usa o value e o onChange */}
          <input 
            type="text" 
        ...
        <button onClick={() => window.open('https://discord.com', '_blank')} className="bg-[#5865F2] hover:bg-[#4752C4] px-5 py-2 rounded-md font-bold text-base flex items-center shadow-lg text-white transition-colors">
